            ...
            <div class="fui-content navbar" id="container" style="background-color: #fafafc;overflow: inherit">
                <div class="default-items">
                    <div class="fui-swipe">
					    ...
					    <div style="width:100%;background-color:#ffffff;display:flex;margin:8px 0;padding:2px 0 10px 0">
                        <a style="width:33.3%; display:flex; flex-direction: column;align-items: center;" href="<?php echo $cdnserver?>user/regsite.php">
                            <img style="width:40px;height:40px;" src="<?php echo $cdnserver?>template/storenews/tupian/zhunqian.png" />
                            <p style="font-size:12px;font-weight:600">开通分站赚钱</p>
                        </a>
                        <div style="width:1px;background-color:#eeeeee;"></div>
                        <a style="width:33.3%;display:flex;flex-direction: column;align-items: center;" href="<?php echo $cdnserver?>?mod=article&id=3" target="_blank" >
                            <img style="width:40px;height:40px;" src="<?php echo $cdnserver?>template/storenews/tupian/tuandui.png" />
                            <p style="font-size:12px;font-weight:600">无限裂变分佣</p>
                        </a>
                        <div style="width:1px;background-color:#eeeeee;"></div>
                        <a style="width:33.3%;display:flex;flex-direction: column;align-items: center;" href="<?php echo $cdnserver?>user/upsite.php">
                            <img style="width:40px;height:40px;" src="<?php echo $cdnserver?>template/storenews/tupian/shengji.png" />
                            <p style="font-size:12px;font-weight:600">初级站长升级</p>
                        </a>
                    </div>
                  ...
                  <!--  <div class="fui-notice">
					   ...
					   <form action="" method="get" id="goods_search" ><input type="hidden" value="yes" name="search">
                        <div class="fui-searchbar bar" style="background-color: #ffffff;border-top: 0px solid #e7e7e7;padding: 0.1rem 0.5rem;" >
                            <div class="searchbar center searchbar-active" style="padding-right:2.5rem">
                                <input type="submit" class="searchbar-cancel searchbtn" style="width:3.5rem;background-color:#1195da; border-radius:50px;color: #fff;" value="搜索">
                                <div class="search-input" style="border:0px; border-radius:50px;  width:85%;  padding-left:0px;padding-right:0px; background-color: #efeff5;">
                                    <i class="icon icon-search " style="font-size: 0.5rem;"></i>
                                    <input type="text" style="background-color: rgba(0,0,0,0);"  class="search" value="" name="kw" placeholder="输入商品关键字..." id="kw">
                                </div>
                            </div>
                        </div>
                    </form>
