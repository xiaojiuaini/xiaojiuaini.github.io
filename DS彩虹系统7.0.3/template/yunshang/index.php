...
<!--TAB标签开始-->
	<div class="block-title">
        <ul class="nav nav-tabs" data-toggle="tabs">
            <li style="width: 25%;" align="center" class="active"><a href="#shop"><i class="fa fa-shopping-cart"></i> <b>立即下單</b></a></li>
            <li style="width: 25%;" align="center" class=""><a href="#search" id="tab-query"><i class="fa fa-search"></i> <b>订單查询</b></a></li>
			<?php if($conf['fenzhan_buy']==1){?><li style="width: 25%;" align="center"><a href="#Substation"><font color="#FF4000"><i class="fa fa-location-arrow fa-spin"></i> <b>我要加盟</b></font></a></li><?php }?>
            ...
            <li style="width: 25%;" align="center" class=""><a href="#more"><i class="fa fa-list"></i> <b>查看更多</b></a></li>
</ul>
    </div>
<!--TAB标签结束-->
...
<!--在线下單-->
    <div class="tab-pane active" id="shop">
       <center><div class="shuaibi-tip animated tada  text-center"><i class="fa fa-heart text-danger"></i> <b>［<?=date("m月d号")?>］每日上架通知&nbsp;<a href="#anounce" data-toggle="modal" class="label label-danger"><font color="#FFFFFF">点击查看</font></a></b></div></center> 
    ...
    <div class="tab-pane" id="search">
         ...
         <tbody>
            <tr class="shuaibi-tip animation-bigEntrance">
                ...
                <td>
                    <h4><strong>客服</strong></h4>
					<i class="fa fa-fw fa-qq text-primary"></i> <?php echo $conf['kfqq'] ?><br><i class="fa fa-fw fa-history text-danger"></i>售后订單问题请联系客服
                </td>
			...
			<div class="form-group">
				<div class="input-group">
					<div class="input-group-btn">
						<select class="form-control" id="searchtype" style="padding: 6px 4px;width:90px"><option value="0">下單账号</option><option value="1">订單号</option></select>
					</div>
					<input type="text" name="qq" id="qq3" value="" class="form-control" placeholder="请输入要查询的内容（留空则显示最新订單）" onkeydown="if(event.keyCode==13){submit_query.click()}" required="">
					<span class="input-group-btn"><a tabindex="0" class="btn btn-default" role="button" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" title="查询内容是什么？" data-content="请输入您下單时，在第一个输入框内填写的信息。如果您不知道下單账号是什么，可以不填写，直接点击查询，则会根据浏览器缓存查询！"><i class="glyphicon glyphicon-exclamation-sign"></i></a></span>
				</div>
			</div>		
			...
			<div id="result2" class="form-group" style="display:none;">
              <center><small><font color="#ff0000">手机用户可以左右滑动</font></small></center>
				<div class="table-responsive">
					...
					<thead><tr><th>下單账号</th><th>商品名称</th><th>数量</th><th class="hidden-xs">购买时间</th><th>状态</th><th>操作</th></tr></thead>
					<tbody id="list">
					</tbody>
					</table>
				</div>
            ...
            <tbody>
                <tr class="active">
                    <td class="btn-effect-ripple" style="overflow: hidden; position: relative;width: 100%; height: 8em;display: block;color: white;margin: auto;background-color: lightskyblue;"><span class="btn-ripple animate" style="height: 546px; width: 546px; top: -212.8px; left: 56.4px;"></span>
                       ...
                       <i class="fa fa-user-o fa-fw" style="margin-top: 0.7em;"></i><strong>精致版</strong> /<i class="fa fa-user-circle-o fa-fw"></i><strong>高级版</strong>
                       </h3>
                ...
                <tr>
                    <td><strong>旗舰级可以吃下级店铺提成</strong></td>
                </tr>
                <tr class="active">
                    <td>
...
<div class="btn-group btn-group-justified">
		...
		<a target="_blank" class="btn btn-effect-ripple btn-default collapsed" style="overflow: hidden; position: relative;"><b><font color="modal-title">下單日期</font></b></a>
		...
		<marquee class="zmd" behavior="scroll" direction="UP" onmouseover="this.stop()" onmouseout="this.start()" scrollamount="5" style="height:16em">
			<h4 class="modal-title" id="myModalLabel">
                    </h4><table class="table table-hover table-striped" style="text-align:center">
				<thead>
				    <tr></tr><tr><td>本站用户160**482**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【拼夕夕】天卡</font></td></tr><tr></tr><tr><td>本站用户571**319**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">亡者【俗人】天卡</font></td></tr><tr></tr><tr><td>本站用户631**528**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">亡者【小狐狸】天卡</font></td></tr><tr></tr><tr><td>本站用户405**426**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">IOS国际服【Wolfios】周卡</font></td></tr><tr></tr><tr><td>本站用户370**269**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【快蛋】天卡</font></td></tr><tr></tr><tr><td>本站用户867**581**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">亡者【云朵直装】天卡</font></td></tr><tr></tr><tr><td>本站用户367**269**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【快球】天卡</font></td></tr><tr></tr><tr><td>本站用户555**323**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">亡者【俗人】天卡</font></td></tr><tr></tr><tr><td>本站用户581**407**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">亡者【小狐狸】天卡</font></td></tr><tr></tr><tr><td>本站用户703**494**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【独行侠】天卡</font></td></tr><tr></tr><tr><td>本站用户781**714**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【DC】天卡</font></td></tr><tr></tr><tr><td>本站用户963**332**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【拼夕夕】天卡</font></td></tr><tr></tr><tr><td>本站用户348**161**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">亡者【俗人】天卡</font></td></tr><tr></tr><tr><td>本站用户327**599**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【芒果】天卡</font></td></tr><tr></tr><tr><td>本站用户958**964**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">亡者【小狐狸】天卡</font></td></tr><tr></tr><tr><td>本站用户543**635**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【芒果】天卡</font></td></tr><tr></tr><tr><td>本站用户128**964**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【宇航员】天卡</font></td></tr><tr></tr><tr><td>本站用户14**822**</td><td>于近期下單成功</td><td><font color="salmon"><img src="" width="15">盒平直装【麦香】天卡</font></td></tr><tr></tr>        </td></tr></thead>
                </table>
            </marquee>
...
<td align="center"><font size="2"><span id="count_orders"></span>笔<br><font color="#65b1c9"><i class="fa fa-check-square-o fa-2x"></i></font><br>订單总数</font></td>
</tr>
<tr>
...
<td align="center"><font size="2"><span id="count_orders2"></span>笔<br><font color="#65b1c9"><i class="fa fa-check-square fa-2x"></i></font><br>今日订單</font></td>
</tr>
</tbody>
</table>
</div>
        ...
        <div class="modal-body" id="accordion">
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">为什么订單显示已完成了却一直没到账？</a>
					</h4>
				</div>
				<div id="collapseOne" class="panel-collapse in" style="height: auto;">
					<div class="panel-body">
					订單显示（已完成）就证明已经提交到服务器内！<br>
					如果长时间没到账请联系客服处理！<br>
					订單长时间显示（待处理）请联系客服！
					</div>
				</div>
			...
			<div class="panel panel-default" style="margin-bottom: 6px;">
				...
				<div id="collapseThree" class="panel-collapse collapse" style="height: 0px;">
					<div class="panel-body">没有收到请检查自己邮箱的垃圾箱！也可以去查單区：输入自己下單时填写的邮箱进行查單。<br>
					查询到订單后点击（详细）就可以看到自己购买的卡密！
					</div>
				</div>
			</div>
			<div class="panel panel-default" style="margin-bottom: 6px;">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion" href="#collapseFourth" class="collapsed">已付款了没有查询到我订單？</a>
					</h4>
				</div>
				<div id="collapseFourth" class="panel-collapse collapse" style="height: 0px;">
					<div class="panel-body" style="margin-bottom: 6px;">联系客服处理，请提供（付款详细记录截图）（下單商品名称）（下單账号）<br>直接把三个信息发给客服，然后等待客服回复处理（请不要发抖动窗口或者QQ电话）！
					</div>
				</div>
			</div>
			...
			<li class="list-group-item">   
			   ...
			   <div class="pull-left push-10-t">
					<div class="font-w600 push-5">订單售后客服</div>
                ...
                <table class="table table-borderless table-vcenter">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 20px;">精致版/高级版</th>
                        </tr>
                    </thead>
					<tbody>
						<tr class="active">
