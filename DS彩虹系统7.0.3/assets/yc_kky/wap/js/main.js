...
function getPoint(){
    ...
    if(inputname=='hide'){
        ...
        $('#inputsname').append('<div class="phone">   <label id="inputname">' + inputname + '</label><input type="text" name="inputvalue" id="inputvalue" value="'+($_GET['qq']?$_GET['qq']:'')+'" placeholder="请输入QQ账号" class="fui-input" required onblur="checkInput()"/></div>');
        ...
        if(inputsname!=''){
            $.each(inputsname.split('|'), function(i, value) {
                ...
                if(value.indexOf('{')>0 && value.indexOf('}')>0){
                    ...
                    $('#inputsname').append('<div class="phone"> <label  id="inputname'+(i+2)+'">' + selectname + '</label><input type="text" class="fui-input" name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" value="" onBlur="window.scrollTo(0, 0);"></div>');
                }else{
                    if(value=='说说ID'||value=='说说ＩＤ'||inputsnametype=='ssid')
                        ...
                        var addstr='';
                    if(addstr!=''){
                        $('#inputsname').append('<div class="phone"> <label id="inputname'+(i+2)+'" gettype="'+inputsnametype+'">' + value + '</label><input type="text" class="fui-input" name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" value="" onBlur="window.scrollTo(0, 0);">' + addstr + '</div>');
                    }else{
                        $('#inputsname').append('<div class="phone"> <label id="inputname'+(i+2)+'" gettype="'+inputsnametype+'">' + value + '</label><input type="text" class="fui-input" name="inputvalue'+(i+2)+'" id="inputvalue'+(i+2)+'" value="" onBlur="window.scrollTo(0, 0);">' + addstr + '</div>');
                    }
                }
