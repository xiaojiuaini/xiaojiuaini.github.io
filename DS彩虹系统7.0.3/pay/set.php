...
<?php
	...
	saveSetting('epay_url',$_POST['epay_url']);
...
<div class="panel-body">
  <form action="./set.php?mod=pay_n" method="post" class="form-horizontal" role="form">
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="alipay_api" default="<?php echo $conf['alipay_api']?>"><option value="0">关闭</option><option value="2">易支付</option></select>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="tenpay_api" default="<?php echo $conf['tenpay_api']?>"><option value="0">关闭</option><option value="2">易支付</option></select>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="qqpay_api" default="<?php echo $conf['qqpay_api']?>"><option value="0">关闭</option><option value="2">易支付</option></select>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<select class="form-control" name="wxpay_api" default="<?php echo $conf['wxpay_api']?>"><option value="0">关闭</option><option value="2">易支付</option></select>
	...
	<div class="form-group">
		<label class="col-lg-3 control-label">当前接口API</label>
		<div class="col-lg-8">
			<input type="text" name="epay_url" class="form-control"
				   value="<?php echo $conf['epay_url']?>"disabled="" >	
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<input type="text" name="epay_url" class="form-control"
				   value="<?php echo $conf['epay_url']?>" placeholder="请以http://开头/结尾">
		</div>
	</div>
		<div class="form-group">
  ...
  <a href="http://www.douaipay.com/"target="_blank "></a>
</div>
</div>
<script>
...
?>
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title">易支付设置</h3></div>
<div class="panel-body">
...
echo '<div class="panel panel-primary"><div class="panel-heading w h"><h3 class="panel-title">易支付结算记录</h3></div>
...
echo '<div class="panel panel-primary"><div class="panel-heading"><h3 class="panel-title">易支付订单记录</h3></div>订单只展示前30条[<a href="set.php?mod=epay">返回</a>]
	<div class="table-responsive">
        <table class="table table-striped">
